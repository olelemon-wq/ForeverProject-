...
# 7. Remove sidebar billing nav button
...
# 8. Remove Privacy settings card from sidebar
...
# 9. Extract original blocks from page.tsx to prevent breaking any layouts
...
# 10. Reconstruct settings form body
...
# 11. Remove duplicate standalone billing tab section at the bottom if present
...
# 12. Add circular & cover repositioning crop overlays/modals at the bottom of JSX (right before the final return closing tags)
modal_target = """      </main>
    </div>
  );
}"""

modal_repl = """      {/* Cover Crop Modal */}
            ...
            <div 
              ...
              onMouseDown={(e) => {
                ...
                const handleMouseMove = (ev: MouseEvent) => {
                  setDeceasedCoverX(ev.clientX - startX);
                  setDeceasedCoverY(ev.clientY - startY);
                };
                const handleMouseUp = () => {
              ...
              onTouchStart={(e) => {
                ...
                const handleTouchMove = (ev: TouchEvent) => {
                  ...
                  setDeceasedCoverX(t.clientX - startX);
                  setDeceasedCoverY(t.clientY - startY);
                };
...
print("page.tsx cover cropped and settings tabs successfully applied!")
