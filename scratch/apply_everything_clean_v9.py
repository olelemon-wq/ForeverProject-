              ...
              {activeSubTab === 'general' && (
                <div className="space-y-6 animate-fade-in text-left">
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-stone-655 tracking-wide">ชื่อหน้ารำลึก</label>
                    <input 
                      type="text" 
                      value={siteName} 
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-stone-550 uppercase tracking-wide">คำอาลัยและคำรำลึก (ประวัติโดยย่อ)</label>
                    <textarea 
                      value={biography} 
