...
grid_end = content.find('        {/* Family Tree Manager */}')
...
family_start = content.find('        {/* Family Tree Manager */}')
family_end = content.find('        {/* E-Book Manager */}')
...
ebook_start = content.find('        {/* E-Book Manager */}')
ebook_end = content.find('        {/* Condolences Moderation */}')
...
condo_start = content.find('        {/* Condolences Moderation */}')
