    ...
    >
      <MarketingSection title="ทำไมถึงมี FOREVER">
        <p>
          ...
          — ทั้งสำหรับรำลึกถึงผู้ล่วงลับ เรื่องเล่าครอบครัว เรื่องราวเธอกับฉัน งานวิวาห์ แก๊งเพื่อน
          และน้องที่รัก — โดยไม่ต้องเป็นนักออกแบบหรือนักพัฒนา
        </p>
        <p>
          ...
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1">
                ...
                — รำลึกถึงผู้ล่วงลับ เรื่องเล่าครอบครัว เรื่องราวเธอกับฉัน งานวิวาห์ แก๊งเพื่อน และน้องที่รัก —
