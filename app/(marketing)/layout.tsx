...
export default function MarketingLayout({
  ...
  return (
    <div className="marketing-light-surface min-h-screen bg-[#F5F5F7] text-[#1D1D1F] selection:bg-emerald-200 selection:text-stone-900 font-sans [color-scheme:light]" style={{ colorScheme: 'light' }}>
      {/* Navbar */}
