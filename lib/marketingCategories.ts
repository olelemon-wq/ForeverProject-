...
export const MARKETING_CATEGORIES: MarketingCategory[] = [
  {
    ...
    accent: '#5c6b52',
    th: {
      title: 'รำลึกถึงผู้ล่วงลับ',
      tagline: 'รำลึกผู้ล่วงลับด้วยชีวประวัติ สมุดไว้อาลัย และคลังภาพ',
      cardDesc: 'ที่สำหรับคนที่คุณคิดถึง รวมเรื่องราว ภาพถ่าย และคำไว้อาลัยในลิงก์เดียว',
      pageIntro:
    ...
    en: {
      ...
      cardDesc: 'A dignified space for the person you miss, with stories, photos, and tributes in one link',
      pageIntro:
  ...
  },
  {
    ...
    accent: '#8ba8bd',
    th: {
      title: 'เรื่องเล่าครอบครัว',
      tagline: 'เก็บประวัติ ภาพถ่าย และภูมิปัญญาของครอบครัว ส่งต่อให้ลูกหลาน',
      cardDesc: 'บ้านดิจิทัลของครอบครัว มีผังเครือญาติ ภาพเก่า เรื่องเล่า และบันทึกจากผู้ใหญ่',
      pageIntro:
  ...
  },
  {
    ...
    en: {
      ...
      cardDesc: 'A home base for your crew, with photos, messages, and moments worth keeping',
      pageIntro:
...
/** Display-only until meeting prices are locked. Keep in sync with the home pricing block. */
export const MARKETING_DISPLAY_PRICE = {
  th: { amount: '฿1,800', period: '/ ปี', cta: 'กดสั่งซื้อ' },
  en: { amount: '฿1,800', period: '/ year', cta: 'Order now' },
} as const;
